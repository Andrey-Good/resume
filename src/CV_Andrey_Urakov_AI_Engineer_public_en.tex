...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, SQL (SQLite)} \\     \textbf{ML/Data}{: PyTorch, NumPy, Classical ML (linear models, SVM/kernels, Bayesian methods, PCA), Model Evaluation, Data Annotation} \\     \textbf{Engineering}{: Git, System Design (Local-First systems, Event-driven), Architecture Patterns (IPC, Queues), Windows environment} \\     \textbf{Soft Skills}{: Technical Writing (RFC/Specs), Project Leadership (5 people), Research Mindset} \\     \textbf{Human Languages}{: Russian (Native), English (B1 - Intermediate)}    }}
 \end{itemize}
