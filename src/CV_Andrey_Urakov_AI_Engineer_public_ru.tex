...
\begin{center}
    ...
    \small{}Екатеринбург $|$ \href{https://t.me/andrey\_urakov\_ml}{\underline{tg: @andrey\_urakov\_ml}} $|$ \href{mailto:urakov18.a@gmail.com}{\underline{urakov18.a@gmail.com}} $|$ \href{https://github.com/Andrey-Good}{\underline{github.com/Andrey-Good}}\end{center}
...
\section{Навыки}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Языки программирования}{: Python (Multiprocessing, AsyncIO, Typer), SQL (SQLite)} \\     \textbf{ML/Data}{: PyTorch, Classical ML (linear models, SVM/kernels, Bayesian methods, PCA), Model Evaluation, Data Annotation} \\     \textbf{Engineering}{: Git, System Design (Local-First systems, Event-driven), Architecture Patterns (IPC, Queues), Linux (WSL environment)} \\     \textbf{Soft Skills}{: Technical Writing (RFC/Specs), Project Leadership (5 человек), Research Mindset} \\     \textbf{Языки}{: Russian (Native), English (B1 - Intermediate)}    }}
 \end{itemize}
